package com.microservices.twitter.elastic.query.client.service.impl;

import com.microservices.twitter.config.ElasticConfigData;
import com.microservices.twitter.config.ElasticQueryConfigData;
import com.microservices.twitter.elastic.model.index.impl.TwitterIndexModel;
import com.microservices.twitter.elastic.query.client.exception.ElasticQueryClientException;
import com.microservices.twitter.elastic.query.client.service.ElasticQueryClient;
import com.microservices.twitter.elastic.query.client.util.ElasticQueryUtil;
